...
# Release script for TrBlazeUI.Icons.Lucide
...
PROJECT_PATH="src/TrBlazeUI.Icons.Lucide"
...
echo -e "${COLOR_YELLOW}═══════════════════════════════════════════════════${COLOR_RESET}"
echo -e "Package:  ${COLOR_GREEN}TrBlazeUI.Icons.Lucide${COLOR_RESET}"
...
git tag -a "$TAG_NAME" -m "Release TrBlazeUI.Icons.Lucide v${VERSION}"
