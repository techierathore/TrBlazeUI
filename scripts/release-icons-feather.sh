...
# Release script for TrBlazeUI.Icons.Feather
...
PROJECT_PATH="src/TrBlazeUI.Icons.Feather"
...
echo -e "${COLOR_YELLOW}═══════════════════════════════════════════════════${COLOR_RESET}"
echo -e "Package:  ${COLOR_GREEN}TrBlazeUI.Icons.Feather${COLOR_RESET}"
...
git tag -a "$TAG_NAME" -m "Release TrBlazeUI.Icons.Feather v${VERSION}"
